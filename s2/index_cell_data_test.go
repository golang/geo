...
func TestIndexCellDataLoadStuff(t *testing.T) {
		...
		*/
		{
			...
			index: "## 2:0, 0:-2, -2:0, 0:2; 0:1, -1:0, 0:-1, 1:0;",
		},
		{
			// Polygon with improperly oriented hole should fail.
			index: "## 2:0, 0:-2, -2:0, 0:2; 1:0, 0:-1, -1:0, 0:1;",
		},
		{
			// constructed to avoid triggering the interior-on-the-right check.
			index: "## 0:-6, -6:0, 0:6, 6:0 ; 0:0, 3:0, 6:0, 6:3, 6:6, 3:6, 0:6, 0:3",
		},
		/*
		 */
	}
